...
void AttitudeIndicatorNeedle::draw(QPainter *painter, const QPoint &center, int length,
...
void AttitudeIndicator::drawScale(QPainter *painter, const QPoint &center, int radius,
                                  double origin, double minArc, double maxArc) const
{
