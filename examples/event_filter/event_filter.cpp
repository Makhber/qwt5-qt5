...
int main(int argc, char **argv)
{
    ...
    a.connect(scalePicker, SIGNAL(clicked(int, double)), plot, SLOT(insertCurve(int, double)));
    ...
    const char *text = "An useless plot to demonstrate how to use event filtering.\n\n"
