...
//! Copy constructor
QwtLinearColorMap::QwtLinearColorMap(const QwtLinearColorMap &other) : QwtColorMap(other)
{
    d_data = new PrivateData;
    *this = other;
}
...
*/
QRgb QwtLinearColorMap::rgb(const QwtDoubleInterval &interval, double value) const
{
...
*/
unsigned char QwtLinearColorMap::colorIndex(const QwtDoubleInterval &interval, double value) const
{
    const double width = interval.width();
...
*/
QwtAlphaColorMap::QwtAlphaColorMap(const QwtAlphaColorMap &other) : QwtColorMap(other)
{
    d_data = new PrivateData;
    *this = other;
}
...
*/
QRgb QwtAlphaColorMap::rgb(const QwtDoubleInterval &interval, double value) const
{
    const double width = interval.width();
    if (width >= 0.0) {
        const double ratio = (value - interval.minValue()) / width;
...
/*!
  ...
  \return Always 0
*/
unsigned char QwtAlphaColorMap::colorIndex(const QwtDoubleInterval &, double) const
{
    return 0;
}
