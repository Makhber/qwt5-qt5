...
*/
void QwtPlotGrid::draw(QPainter *painter, const QwtScaleMap &xMap, const QwtScaleMap &yMap,
...
void QwtPlotGrid::drawLines(QPainter *painter, const QRect &canvasRect, Qt::Orientation orientation,
