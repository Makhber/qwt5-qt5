...
public:
    ...
    inline QPointF pos() const { return QPointF(d_x, d_y); }
...
{
public:
    inline ContourPlane(double z) : d_z(z) { }

    inline bool intersect(const Contour3DPoint vertex[3], QPointF line[2],
...
private:
    ...
    inline QPointF intersection(const Contour3DPoint &p1, const Contour3DPoint &p2) const;

    double d_z;
};

inline bool QwtRasterData::ContourPlane::intersect(const Contour3DPoint vertex[3], QPointF line[2],
                                                   bool ignoreOnPlane) const
{
    bool found = true;
...
inline QPointF QwtRasterData::ContourPlane::intersection(const Contour3DPoint &p1,
                                                         const Contour3DPoint &p2) const
{
...
/*!
   ...
   \sa setBoundingRect()
*/
QwtRasterData::QwtRasterData(const QRectF &boundingRect) : d_boundingRect(boundingRect) { }
...
*/
QwtRasterData::ContourLines QwtRasterData::contourLines(const QRectF &rect, const QSize &raster,
