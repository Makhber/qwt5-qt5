...
//! Default constructor
QwtPaintBuffer::QwtPaintBuffer() : d_device(0), d_painter(0), d_devicePainter(0) { }
...
QwtPaintBuffer::QwtPaintBuffer(QPaintDevice *device, const QRect &rect, QPainter *painter)
...
void QwtPaintBuffer::open(QPaintDevice *device, const QRect &rect, QPainter *painter)
{
    close();
