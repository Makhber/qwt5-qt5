...
QwtScaleDiv::QwtScaleDiv() : d_lowerBound(0.0), d_upperBound(0.0), d_isValid(false) { }
...
*/
QwtScaleDiv::QwtScaleDiv(const QwtDoubleInterval &interval, QList<double> ticks[NTickTypes])
    : d_lowerBound(interval.minValue()), d_upperBound(interval.maxValue()), d_isValid(true)
{
