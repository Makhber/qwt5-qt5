...
*/
QwtAbstractSlider::QwtAbstractSlider(Qt::Orientation orientation, QWidget *parent) : QWidget(parent)
{
...
void QwtAbstractSlider::timerEvent(QTimerEvent *)
{
    ...
    case ScrMouse: {
        if (d_data->mass > 0.0) {
            ...
            const double newval = exactValue() + d_data->speed * double(d_data->updTime);
