...
//! Copy constructor
QwtScaleDraw::QwtScaleDraw(const QwtScaleDraw &other) : QwtAbstractScaleDraw(other)
{
...
*/
QwtMatrix QwtScaleDraw::labelMatrix(const QPoint &pos, const QSize &size) const
{
    QwtMatrix m;
